...
rk_diffsNew2[(i * 14) + (run1)] += + rk_diffK[i * 2]*(real_t)2.5000000000000001e-02 + rk_diffK[i * 2 + 1]*(real_t)2.5000000000000001e-02;
}
}
...
for (i = 0; i < 10; ++i)
{
rk_diffsNew2[(i * 14) + (run1 + 10)] = + rk_diffK[i * 2]*(real_t)2.5000000000000001e-02 + rk_diffK[i * 2 + 1]*(real_t)2.5000000000000001e-02;
}
}
